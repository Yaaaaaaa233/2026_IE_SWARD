...
- [ADR-0002：评价指标与基线比较口径提议](ADR-0002-evaluation-metrics.md)（Proposed，未冻结）
...
- [ADR-0008：叶安线按新版赛题口径重启特征与模型适配路线](ADR-0008-feat-009-protocol-v2-route.md)（Accepted，2026-09-24；仅方案，执行仍冻结）

...
- [FEAT-014 叶安线特征与模型持续迭代探索](feat-014-adaptive-feature-model-exploration.md)：按 2026-09-26 用户指示启动；E0、B001 独立审计与错误诊断机器检查通过，B002 已按上一批反馈预登记；真实指标和图表仅在受控 `outputs/feat-014/`，实际图表复核待记录。
